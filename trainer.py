...
class TrainerBase:
    ...
    def init_logger(self):
        ...
        if self.wandb_logging:
            if self.rank == 0:
                wandb_entity = self.configs.train.get('wandb_entity', None)
                wandb_project = self.configs.train.get('wandb_project', 'default-project')
                wandb_run_name = self.configs.train.get('wandb_run_name', run_name)
        ...
        if self.rank == 0:
            cfg_path = self.configs.cfg_path
