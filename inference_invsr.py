...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        "--cfg_path", type=str, default="./configs/sample-sd-turbo-brainsr.yaml", help="Configuration path.",
    )
    parser.add_argument(
...
def get_configs(args):
    ...
    if args.started_ckpt_path:
        ...
        started_ckpt_name = "brain-sr-noise-predictor.pth"
        ...
        if not started_ckpt_path.exists():
            load_file_from_url(
                url="https://huggingface.co/infopz/brain-sr/resolve/main/brain-sr-noise-predictor.pth",
