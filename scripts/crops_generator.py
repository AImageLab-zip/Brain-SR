...
if __name__ == "__main__":
    ...
    lr_path = "BigBrain/low_res_coronal_minc/"
    # LR download path (via FTP): https://ftp.bigbrainproject.org/bigbrain-ftp/BigBrainRelease.2015/2D_Final_Sections/Coronal/Minc/

    hr_path = "BigBrain/high_res_aligned/"
    # HR (+HR affines) download path (via browser): https://search.kg.ebrains.eu/instances/73c1fa55-d099-4854-8cda-c9a403c6080a

    out_path = "crops_datasets/test/"
    ...
    crop_generator.compute_list(exclude_ids=[])
    crop_generator.generate_crops()
    ...
    #
    # lr_path = "BigBrain/low_res_coronal_minc/pm2956o.mnc"
    # hr_affine_path = "BigBrain/high_res_aligned/B20_2956_affine.json"
    # hr_path = "BigBrain/high_res_aligned/B20_2956.tif"
    # 
    # out_path = "crops/crop_test/"
    # 
    # crop_config = CropConfig(
    #     lr_crop_size=128,
    #     hr_crop_size=512,
